...
Note: To remove the effects of gravity, you can edit the gravity to 0.0 in line 17 of 
...
Note: If you have an external python package like "general_robotics_toolbox", add it to my_source.zip
